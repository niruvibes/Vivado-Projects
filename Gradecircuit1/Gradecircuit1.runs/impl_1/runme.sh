...
HD_PWD='C:/Users/neilt/Documents/UNSW/ELEC2141/Gradecircuit1/Gradecircuit1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Gradecircuit1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Gradecircuit1.tcl -notrace

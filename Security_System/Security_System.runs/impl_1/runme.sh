...
HD_PWD='C:/Users/neilt/Documents/UNSW/Vivado-Projects/Security_System/Security_System.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Security_System.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Security_System.tcl -notrace
